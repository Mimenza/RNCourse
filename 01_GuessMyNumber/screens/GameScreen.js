...
function GameScreen({ userNumber, onGameOver }) {
  const initialGuess = generaterRandomNumber(1, 100, userNumber);
  ...
  function nextGuessHandler(direction) {
    ...
    let rndNum = generaterRandomNumber(minBoundary, maxBoundary, currentGuess);
    setCurrentGuess(rndNum);

    setGuessRounds((currentRounds) => [rndNum, ...currentRounds]);
  }
